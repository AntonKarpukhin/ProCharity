...
const checkDataInputState = () => {
  dateInputs.forEach((input) => {
    if (input.value === '') {
      ...
      field.querySelector('.form__placeholder').classList.remove('form__placeholder_type_is-fixed');
      field.querySelector('.form__input-button_type_reset').classList.remove('form__input-button_active');
    }
...
document.addEventListener('click', (evt) => {
  if (!evt.target.classList.contains('form__input_type_date') && !evt.target.classList.contains('form__input_hidden')) {
    checkDataInputState();
  }
});
...
formFields.forEach((field) => {
  ...
  field.addEventListener('click', (evt) => {
    ...
    if (evt.target.classList.contains('form__input-button_type_reset')) {
      ...
      field.querySelector('.form__placeholder_type_is-fixed').classList.remove('form__placeholder_type_is-fixed');
      field.querySelector('.form__input-button_type_reset').classList.remove('form__input-button_active');
    }
    ...
    if (evt.target.classList.contains('form__input-button_type_show-password')) {
      ...
      field.querySelector('.form__input-button_type_hide-password').classList.add('form__input-button_active');
    }

    if (evt.target.classList.contains('form__input-button_type_hide-password')) {
      field.querySelector('.form__input').type = 'password';
      evt.target.classList.remove('form__input-button_active');
      field.querySelector('.form__input-button_type_show-password').classList.add('form__input-button_active');
    }
...
form.addEventListener('change', () => {
  formFields.forEach((field) => {
    ...
    const fixedPlaceholder = field.querySelector('.form__placeholder_type_is-fixed');
    ...
    if (resetInputButton && resetInputButton.classList.contains('form__input-button_active') && !input.value) {
